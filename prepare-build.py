        ...
        steps = [
            {
                ...
                "with": {
                    "packages": "build-base freetype wayland wayland-dev dbus dbus-dev libxkbcommon libxkbcommon-dev mesa-egl glfw glfw-dev glfw-wayland-dev meson cmake git wayland-protocols nodejs"
                }
            }
        ]
    else:
